...
var Component = (function () {
    function Component(name, language) {
        ...
        this.genericCodeAfterComponentExtending = "";
        this.isLayout = false;
        this.name = name;
    ...
    Component.prototype.processHTMLElement = function (el, componentTag, document) {
        ...
        var innerComponents = Array.from(el.querySelectorAll(componentTag + ", [" + componentTag + "]"));
        ...
        var jsxString = el.nodeName === componentTag ? el.innerHTML : el.outerHTML;
